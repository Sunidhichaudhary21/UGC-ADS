        ...
        >
          ...
          {!forCommunity && (
            <div
              ...
              className="absolute right-3 top-3 sm:capacity-0
                group-hover:opacity-100 transition flex items-center gap-2"
            >
              <div className="absolute top-3 right-3">
                <EllipsisIcon
                  className="ml-auto bg-back/10 rounded-full
                        p-1 size-7"
                />
              </div>
                ...
                >
                  ...
                  {gen.generatedVideo &&
                    ...
                    onClick={()=>navigator.share({url:gen.generatedVideo || gen.generatedImage,
                      ...
                      className="w-full flex gap-2 items-center px-4 py-4 hover:bg-black/10 cursor-pointer">
                      <Share2Icon size={14}/> Share
                    </button>}

                    <button onClick={()=>handleDelete(gen.id)} className="w-full flex gap-2 items-center px-4 py-2 hover:bg-red-950/10
                    text-red-400">
          ...
          <div className="absolute right-3 bottom-3">
            ...
            <img
              ...
              alt="model"
              className="w-16 h-16
                object-cover rounded-full animate-float -ml-8 style={{animationDelay:'3s'}}"
            />
          </div>
        </div>
        ...
        <div className="p-4">
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="text-right">
              <div className="mt-2 flex flex-col items-end gap-1">
                <span
                  className="text-xs px-2 py-1 bg-white/5
                        rounded-full"
                >
          ...
          {gen.productDescription && (
            <div className="mt-3">
              ...
              <div
                className="text-sm text-black-300 bg-white/3 p-2
                    rounded-md wrap-break-word"
              >
                {gen.productDescription}
              </div>
            </div>
          ...
          {gen.userPrompt && (
            <div className="mt-3">
              <div className="text-xs text-black-300">{gen.userPrompt}</div>
            </div>
          )}
